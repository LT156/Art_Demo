...
from Abstract_vocabulary_aid_Demo.code.original_model.neural_models.resnet_encoder import ResnetEncoder
from Abstract_vocabulary_aid_Demo.code.artemis_model.neural_models.attentive_decoder import AttentiveDecoder
from Abstract_vocabulary_aid_Demo.code.feat_extracted_model.ResNetWSL import ResNetWSL
from Abstract_vocabulary_aid_Demo.code.feat_extracted_model.ClassWisePool import ClassWisePool
...
def describe_model(vocab,args):
    ...
    decoder = AttentiveDecoder(word_embedding,
                               ...
                               abstract_projection_net = abstract_projection_net,
                               auxiliary_dim=emo_ground_dim,
                               abstract_dim=abstract_ground_dim
                               )
