...
from Xmodal_Ctx_lcs.in_out.basics import pickle_data
from Xmodal_Ctx_lcs.in_out.arguments import parse_test_speaker_arguments
from Xmodal_Ctx_lcs.in_out.neural_net_oriented import torch_load_model, load_saved_speaker, seed_torch_code
from Xmodal_Ctx_lcs.neural_models.attentive_decoder import negative_log_likelihood
from Xmodal_Ctx_lcs.captioning.sample_captions import versatile_caption_sampler, captions_as_dataframe
from Xmodal_Ctx_lcs.in_out.datasets import sub_index_affective_dataloader
from Xmodal_Ctx_lcs.in_out.datasets import default_grounding_dataset_from_affective_loader
from Xmodal_Ctx_lcs.in_out.datasets import custom_grounding_dataset_similar_to_affective_loader
...
if __name__ == '__main__':
    ...
    for config in sampling_configs:
        ...
        df.to_csv(os.path.join(args.out_file,'result2.csv'))
        final_results.append([config, df, attn_weights])
        print('Done.')
    
    pickle_data(os.path.join(args.out_file,'result2.pkl'), final_results)
