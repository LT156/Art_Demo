...
class ImageClassificationDataset(Dataset):
    def __init__(self, image_files, labels=None, abstract_features=None,img_transform=None, rgb_only=True):
    ...
    def __getitem__(self, index):
        ...
        res = {'image': img, 'label': label,'abstract_data':abstract_data, 'index': index}
        return res
...
def group_annotations_per_image(affective_dataset):
    ...
    return tokens_grouped['image_files'], tokens_grouped['tokens_encoded'], emotion_gt_max,unique_id_grouped['unique_id']
