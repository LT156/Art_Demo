...
def parse_train_speaker_arguments(notebook_options=None, save_args=False):
    ...
    # config
    parser.add_argument('--cfg', type=str, default='F:/work/Image_emotion_analysis/artemis-master/RAIVS/configs_local/rl_train_small.yml',
...
def parse_test_speaker_arguments(notebook_options=None):
    ...
    # config
    parser.add_argument('--cfg', type=str, default=r'F:\work\Image_emotion_analysis\artemis-master\RAIVS\configs_local\rl_decode_test_small.yml',
                    help='configuration; similar to what is used in detectron')
    parser.add_argument(
        '--set_cfgs', dest='set_cfgs',
        help='Set config keys. Key value sequence seperate by whitespace.'
...
def parse_test_evaluation_arguments(notebook_options=None):
    ...
    # config
    parser.add_argument('--cfg', type=str, default=r'F:\work\Image_emotion_analysis\artemis-master\RAIVS\configs_local\rl_evaluation_small.yml',
                    help='configuration; similar to what is used in detectron')
    parser.add_argument(
        '--set_cfgs', dest='set_cfgs',
        help='Set config keys. Key value sequence seperate by whitespace.'
