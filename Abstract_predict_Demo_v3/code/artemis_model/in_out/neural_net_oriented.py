...
from .datasets import AffectiveCaptionDataset, WordsPredictDataset
...
def pass_artemis_splits_to_datasets(df, load_imgs, img_transforms, top_img_dir, one_hot_emo=True):
    ...
    for split, g in df.groupby('split'):
        ...
        dataset = AffectiveCaptionDataset(img_files,g.abstract_words_feature, g.tokens_encoded, g.emotion_label,g.painting,
...
def image_emotion_distribution_df_to_pytorch_dataset(df, args, drop_thres=None):
    ...
    for split, g in df.groupby('split'):
        ...
        dataset = WordsPredictDataset(img_files, g.abstract_features,
