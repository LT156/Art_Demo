...
from Abstract_predict_Demo_v3.code.artemis_model.in_out.neural_net_oriented import  torch_save_model
from Abstract_predict_Demo_v3.code.artemis_model.in_out.basics import create_dir
from Abstract_predict_Demo_v3.code.model.Abs_Attr_Model import Abs_Attr_Model, evaluation_index, single_epoch_eval, single_epoch_train
...
def get_args():
    ...
    # config
    parser.add_argument('--cfg', type=str, default='F:/work/Image_emotion_analysis/artemis-master/Abstract_predict_Demo_v3/config/image2word_local.yml',
...
if __name__=='__main__':
    ...
    optimizer = torch.optim.Adam([{'params': filter(lambda p: p.requires_grad, model.parameters()), 'lr': 5e-3}])
