...
from Abstract_predict_Demo_v3.code.data_object.Vocabulary import Vocabulary


def get_args():
    parser = argparse.ArgumentParser(description='prepare_additional_data')
    # config
    parser.add_argument('--cfg', type=str, default='F:/work/Image_emotion_analysis/artemis-master/Abstract_predict_Demo_v3/config/prepared_data_local2.yml',
