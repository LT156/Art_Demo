...
from Image_affective_recognition_Demo_v2.code.data_object.Vocabulary import Vocabulary


def get_args():
    parser = argparse.ArgumentParser(description='prepare_additional_data')
    # config
    parser.add_argument('--cfg', type=str, default='F:/work/Image_emotion_analysis/artemis-master/Image_affective_recognition_Demo_v2/config/prepared_data_local2.yml',
...
if __name__=='__main__':
    ...
    img_emo_df.emotion_histogram = img_emo_df.emotion_histogram.apply(literal_eval)
