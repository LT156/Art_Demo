...
from Image_affective_recognition_Demo_v2.code.artemis_model.in_out.neural_net_oriented import  torch_load_model
from Image_affective_recognition_Demo_v2.code.artemis_model.in_out.basics import create_dir
from Image_affective_recognition_Demo_v2.code.model.Abs_Attr_Model import Abs_Attr_Model, evaluation_index
...
def get_args():
    ...
    # config
    parser.add_argument('--cfg', type=str, default='F:/work/Image_emotion_analysis/artemis-master/Image_affective_recognition_Demo_v2/config/word_evaluation_local.yml',
