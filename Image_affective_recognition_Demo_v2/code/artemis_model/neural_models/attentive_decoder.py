...
class AttentiveDecoder(nn.Module):
    ...
    def __init__(self, word_embedding, rnn_hidden_dim, encoder_dim, attention_dim,
                 ...
                 auxiliary_net=None,abstract_projection_net=None, auxiliary_dim=0):
        """
        ...
        self.decode_step = nn.LSTMCell(word_embedding.embedding_dim + encoder_dim + 512+auxiliary_dim, rnn_hidden_dim)
    ...
    def sort_captions_and_forward(self, encoder_out, captions, auxiliary_data=None,abstract_data=None):
        ...
        for t in range(max(decode_lengths)):
            ...
            if auxiliary_data is not None:
                ...
                decoder_in = torch.cat([decoder_lang_input, attention_weighted_encoding,abstract_data_t, auxiliary_data_t], dim=1)
            else:
